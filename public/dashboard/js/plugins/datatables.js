    ...
    "bootstrap": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).addClass('pagination').append(
                '<ul>' +
                '<li class="prev disabled"><a href="#"><i class="fa fa-chevron-right"></i></a></li>' +
                '<li class="next disabled"><a href="#"><i class="fa fa-chevron-left"></i></a></li>' +
                '</ul>'
            );
            var els = $('a', nPaging);
...
$(document).ready(function () {
    ...
    tableElement.dataTable({
        "pageLength": 1,
        "sDom": "<'row'<'col-xs-12 col-md-6 datatable-tools'l T><'col-xs-12 col-md-6 datatable-tools'f>r>t<'row'<'col-md-12'p i>>",
        "oTableTools": {
            "aButtons": [
                {
                    "sExtends": "collection",
        ...
        "oLanguage": {
            ...
            "sUrl": "/js/dashboard/plugins/jquery-datatable/Persian.json"
        },
        bAutoWidth: false,
    ...
    var oTable = $('#example2').dataTable({
        "sDom": "<'row'<'col-xs-12 col-md-6 datatable-tools'l><'col-xs-12 col-md-6 datatable-tools'f>r>t<'row'<'col-md-12'p i>>",
        "aaSorting": [],
        "oLanguage": {
            "sLengthMenu": "_MENU_ ",
            "sInfo": "Showing <b>_START_ to _END_</b> of _TOTAL_ entries",
    ...
    var oTable3 = $('#example3').dataTable({
        "sDom": "<'row'<'col-xs-12 col-md-6 datatable-tools'l <'toolbar'>><'col-xs-12 col-md-6 datatable-tools'f>r>t<'row'<'col-md-12'p i>>",
        "oTableTools": {
            "aButtons": [
                {
                    "sExtends": "collection",
