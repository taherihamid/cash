(function ($) {
    ...
    Webarch.prototype.initScrollUp = function () {
        $('[data-dashboard="scrollup"]').click(function () {
            $("html, body").animate({
                scrollTop: 0
            }, 700);
            return false;
        ...
        $(window).scroll(function () {
            if ($(this).scrollTop() > 100) {
                $('[data-dashboard="scrollup"]').fadeIn();
            } else {
                $('[data-dashboard="scrollup"]').fadeOut();
            }
        });
    }
    // Portlet / Panel Tools
    ...
    Webarch.prototype.initSideBarToggle = function () {
        var $this = this;
        $('[data-dashboard="toggle-left-side"]').on('touchstart click', function (e) {
            e.preventDefault();
            $this.toggleLeftSideBar();
        });
        $('[data-dashboard="toggle-right-side"]').on('touchstart click', function (e) {
            e.preventDefault();
    ...
    Webarch.prototype.initUtil = function () {
        ...
        $('[data-dashboard-toggler="checkall"]').on('click', function () {
            var $el = $(this);
