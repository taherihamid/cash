            ...
            <div class="col-12">
                <div class="col">
                    <div class="row">
                        ...
                        <strong class="col" style="text-align: right">As an Agent</strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col" style="color: #8B91A0">Credit Request</div>
                        <strong class="col" style="text-align: right">{{client.credit_limit}} $ </strong>
                        <hr style="border-width:0; margin: 10px">
                    ...
                    <div v-show="client.status == 2" class="row" style="margin-top: 10px">
                        <button class="btn btn-primary" v-on:click="updateAgentInfo(client)"
                                style="margin-bottom:10%;border-radius: 20px;width: 90%;margin-left: 5%;">
...
<script>
    export default {
        ...
        methods: {
            ...
            ,
            updateAgentInfo: function(client) {

                this.$emit('show_agent_info_modal', client)
            }
