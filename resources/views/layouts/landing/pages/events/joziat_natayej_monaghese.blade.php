                            ...
                            <div class="form">
                                <fieldset>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                        <div class="col-lg-10 col-md-10">
                                                            <label for="name">مهلت پذیرش برنده بودن</label>
                                                            <div>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                        <div class="col-lg-10 col-md-10">
                                                            <label for="name">زمان شروع بازگشایی</label>
                                                            <div>
                                                                <input type="text" class="form-control col-md-10"
                                                                    id="exampleInput2" />
                                                                <span class="fa fa-calendar fa-2x col-md-2 text-primary"
                                        ...
                                        <div class="row">
                                            <h3 style="margin-bottom: 25px">لیست مناقصه گران</h3>
                                            <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-4 col-sm-6 col-xs-12" style="text-align: center">
                                                <button type="button" class="btn btn-primary">پذیرش برنده بودن</button>
                                                <button type="button" class="btn btn-primary">عدم پذیرش</button>
