...
@section('content')
    ...
    <div class="line">
        <div class="alert alert-info">
            ...
            <a href="{{ url()->previous() }}" class="btn btn-info" style="float: left">بازگشت</a>
        </div>
        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="order" class="form form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-label" for="parent_id">عضو والد</label>
                                                <select class="form form-control" name="parent_id" required>
                                    ...
                                    @foreach($menus as $menu)
                                        <li>
                                            ...
                                            @if(count($menu->childs))
                                                @include('dashboard.menus.manageChild',['childs' => $menu->childs->sortByDesc('order')])
                                            @endif
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="table-responsive line">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="thead text-center">{{ 'Route Name '}}</th>
                                        <th class="thead text-center">{{ 'پارامتر ها '}}</th>
                                    ...
                                    @foreach($allMenusFullItems as $key =>$value)
                                        <tr class="@if($loop->odd) table-odd-or-even @endif table-active-hover ">
                                            ...
                                            <th class="border-radius-0-6-6-0 border-top-none text-center">{{ $value->route_name }}</th>
                                            <th class="border-radius-0-6-6-0 border-top-none text-center">{{ $value->parameters }}</th>
                                              {{--{{dd($menu_id)}}--}}
                                            ...
                                            <td class="text-center">
                                                <a class="border-none bg-transparent"
                                                   href="{{route('admin.menu.dropSubMenuItem', ['id'=>$value->id])}}">
