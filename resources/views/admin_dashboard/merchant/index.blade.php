        ...
        <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
                <div
                    ...
                    <a href="{{route('admin.merchant.create')}}"><span class="label label-dark label-inline mr-2 scan-button"
                                                                    style="border-radius: 20px;height: 35px;font-size: 13px">  + Add Merchant</span>
                    </a>
...
{{--                            </form>--}}
                            ...
                            <table class="table table-hover table-checkable" id="kt_datatable"
                                ...
                                @foreach($merchants as $merchant)
                                    <tr>
                                        <td>{{ $merchant->full_name ?? 'No Title' }}</td>
                                        <td>25</td>
                                        ...
                                        <td> <span class="label
                                            @if($merchant->order_status == \App\Invoice::Amount_Received)
                                                    label-success
                                            @else
                                                    label-light-dark
