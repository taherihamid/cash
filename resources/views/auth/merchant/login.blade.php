                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-signin">
                        ...
                        <div class="form-container">
                            <form class="form" id="kt_login_signin_form1" method="post" action="{{ route('merchant.logins') }}">
                                @csrf
                                <div class="form-group mb-5">
                                    <label for="email" class="col-md-12 col-form-label text-md-left">{{ "Personal ID" }}</label>
                                    <input class="form-control h-auto form-control-solid py-4 px-8" type="text" id="personal_id" placeholder="Personal ID" name="personal_id" autocomplete="off" />
                                </div>
                                <div class="form-group mb-5">
                                ...
                                <button id="kt_login_signin_submit" type="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4 login-btn">Login</button>
                    ...
                    <div class="login-forgot">
                        ...
                        <div class="form-container">
                            <form class="form" id="kt_login_forgot_form" method="post" action="{{ route('merchant.password.email') }}">
                                @csrf
